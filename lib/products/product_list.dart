...
import 'package:greenilluv1/appconfig/config.dart';
import 'package:greenilluv1/widgets/app_bar.dart';
import 'package:greenilluv1/widgets/appdrawer.dart';
import 'package:greenilluv1/model/any_image.dart';
import 'package:greenilluv1/model/category.dart';
import 'package:greenilluv1/model/product.dart';
import 'package:greenilluv1/widgets/products_list_item.dart';
...
class ProductsListPage extends StatelessWidget {
  ...
  Future<dynamic> _getProductsByCategory(categoryId, pageIndex) async {
    var url = AppConfig.Appurls['wpapi'] + AppConfig.Namespaces["products"]+ "?per_page=50&page=$pageIndex";
    print(url);
